...
export const iFoundItButIDontUnderstandItTitle2 =
  "I Found It, but I Don't Understand It (test)";
export const iFoundItButIDontUnderstandItDate = '6/13/2023';

export const IFoundItButIDontUnderstandIt2 = () => {
  return (
    <Wrapper>
      <Title date={iFoundItButIDontUnderstandItDate} author='Braden Weber'>
        {iFoundItButIDontUnderstandItTitle2}
      </Title>
      <Divider />
      <Body>
...
export default IFoundItButIDontUnderstandIt2;

export const testPost = {
  title: iFoundItButIDontUnderstandItTitle2,
  description: 'Test',
  createdDate: 'date',
  tags: ['game'],
  element: <IFoundItButIDontUnderstandIt2 />,
};
