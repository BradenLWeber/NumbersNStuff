...
export const PrimalSpiralsPt2 = () => {
  return (
    <Wrapper>
      ...
      <Body>
        We must start by asking ourselves, why does the Ulam Spiral make
      ...
      <Body>
        ...
        gaps gaps, while diagonal lines can chain together with no gaps.
      </Body>
      <Body>
      ...
      <Body>
        ...
        will allow for new patterns. That shouldn't be too difficult to
        simulate, so I'm just going to give it a shot.
      </Body>
      <Image
        src={Jump_1_2}
        width={600}
      ...
      />
      <Body>
        Hey! That's the kind of stuff I live for! Still the chaos of primes, but
        still some clear patterns emerging. The kind of result that I don't
        immediately grasp, and I probably never will, but seems important
        somehow.
      </Body>
      <Body>
      ...
      <Body>
        Of course, if we pull every third number, we couldn't start at 0 or else
        we would get 0, 3, 6, 9, etc, and none of them would be prime. But if we
        begin with 1, we'll get 1, 4, 7, 10, etc, and already we can see one
        number is prime. Let's give it a whirl (pun intended)!
      </Body>
      <Image
        src={Jump_1_3}
        width={600}
      ...
      />
      <Body>
        Hey, looking similar to our basic spiral, but with a little difference
      ...
      />
      <Body>
        I mean, doesn't get much better than that! It's interesting that the odd
        number gaps tend to make diagonal lines. I think that makes sense, since
        adding an odd number repeatedly results in even, then odd, then even,
        etc. Since only odd numbers can be primes, the resulting patterns must
        be like a checkerboard again. On the other hand, even number gaps tend
        to make vertical and horizontal lines. I can't quite explain that one at
        the moment. Also interesting to note that, of all these gaps, 6 is by
        far the most prime-concentrated.
      </Body>
      <Body>
        ...
        we could start at any number. That seems like it's worth experiementing
        with!{' '}
      </Body>
      <Body>
        I want to take a semi-small gap and change the starting number to see if
        it makes a difference. I know if we choose an even gap, then all the
        even starting numbers won't produce any primes. So let's choose an odd
        gap, just so the result is more interesting. How about 5? We'll try
        starting with 1, 2, 3, and 4.
      </Body>
      <Image
        src={Jump_1_5}
        width={600}
      ...
      <Body>
        ...
        I'll keep this question in mind as we continue.
      </Body>
      ...
      <Body>
        ...
        list of numbers by using my input as a list of gaps between numbers. So
        the example I just mentioned would look like this:
      </Body>
      ...
      <Body>
        ...
        that follow on general pattern while other sections follow another. For
